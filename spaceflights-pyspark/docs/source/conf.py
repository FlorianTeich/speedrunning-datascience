...
# spaceflights_pyspark documentation build
...
from spaceflights_pyspark import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflights_pyspark"
author = "Kedro"
...
htmlhelp_basename = "spaceflights_pysparkdoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflights_pyspark.tex",
        "spaceflights_pyspark Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflights_pyspark",
        "Project spaceflights_pyspark codebase.",
        "Data-Science",
    )
]
